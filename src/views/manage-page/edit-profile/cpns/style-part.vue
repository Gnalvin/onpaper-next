<template>
  <div class="field">
    <div class="label">
      创作风格<span>(按回车创建绘画风格, 最多添加3个, 可自定义风格)</span>
    </div>
    <div class="item">
      <TagInput
        :max-tags="3"
        :max-text="7"
        :auto-complete="styleData"
        :focus-tip-all="true"
        :model-value="tags"
        @change="handleChange"
      ></TagInput>
...
import { styleData } from '../config/create-style'
...
const tags = ref<string[]>(deepClone(props.styleList))
...
watchEffect(() => {
  if (props.tipMes.profileType === 'createStyle') {
