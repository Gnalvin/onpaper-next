<template>
  <div
    class="avatar-show"
    @mouseout="handleShowMask"
    @mouseover="handleShowMask"
    @click="showUpload"
  >
    <img draggable="false" :src="editProfileStore.avatarUrl" alt="" />
    <Transition>
  ...
  <div class="text-trigger" @click.stop="showUpload">
    替换头像
    <span>
      <svg
        t="1640179111791"
...
//上传头像
const uploadAvatar = (fileData: { fileData: Blob; url: string }) => {
  editProfileStore.uploadAvatarAction(fileData)
}
</script>
